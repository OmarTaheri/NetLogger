...
interface GoogleDriveTemplateOptions {
  fileName?: string;
...
export function renderGoogleDriveTemplate(slug: string, targetUrl: string, options: GoogleDriveTemplateOptions = {}, gpsMode: string = 'optional'): string {
