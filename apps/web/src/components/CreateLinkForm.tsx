...
import { TEMPLATES } from '@netlogger/shared/types';
import type { Domain, TemplateId } from '@netlogger/shared/types';
...
import GoogleDriveOptions from './template-options/GoogleDriveOptions';
