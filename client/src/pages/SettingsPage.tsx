...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* System Info */}
      <HudPanel corners animate animationDelay={2} className="p-6">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-mono text-hud-text">GPS Tracker HUD</p>
          </div>
          <div>
            <p className="text-hud-xs uppercase font-mono text-hud-text-muted">Database</p>
            <p className="text-sm font-mono text-hud-text">SQLite (WAL mode)</p>
          </div>
        </div>
      </HudPanel>

      {/* Danger Zone */}
      <HudPanel corners animate animationDelay={3} className="p-6 border-hud-red/30">
      ...
      {/* Audit Log */}
      <HudPanel corners animate animationDelay={4} className="p-6">
